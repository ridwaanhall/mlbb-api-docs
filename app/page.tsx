...
export default function Home() {
  return (
    <div className="flex sm:min-h-[91vh] min-h-[88vh] flex-col items-center justify-center text-center px-2 py-8">
      ...
      This API documentation provides comprehensive data for Mobile Legends: Bang Bang. Including statistics, hero information, and other relevant details. Example usage of this API documentation is provided in Python.
      </p>
      <div>
        <Link
