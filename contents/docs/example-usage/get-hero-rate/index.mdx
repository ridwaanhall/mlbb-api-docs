...
1. Python Requests
    ...
    api_url = "https://api-mobilelegends.vercel.app/api/hero-rate/127/?past-days=15"
...
2. Direct API Access
    ...
    Click this to [Access the API directly](https://api-mobilelegends.vercel.app/api/hero-rate/127/?past-days=15)
