...
description: This API endpoint uses the main_heroid path parameter (1-127) to retrieve counter information for a hero.
---
...
2. Direct API Access
    ...
    Click this to [Access the API directly](https://api-mobilelegends.vercel.app/api/hero-counter/127/)
