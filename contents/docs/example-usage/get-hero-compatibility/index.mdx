...
description: API endpoint uses main_heroid (1-127) to fetch hero compatibility data.
---
...
2. Direct API Access
    ...
    Click this to [Access the API directly](https://api-mobilelegends.vercel.app/api/hero-compatibility/127/)
