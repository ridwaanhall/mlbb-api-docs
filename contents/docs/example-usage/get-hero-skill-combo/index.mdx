...
### Python requests
    ...
    api_url = "https://api-mobilelegends.vercel.app/api/hero-skill-combo/127"
...
### Direct API Access
    ...
    Click this to [Access the API directly](https://api-mobilelegends.vercel.app/api/hero-skill-combo/127)
