...
description: This API endpoint uses the main_heroid path parameter (1-130 (still update until now)) to retrieve counter information for a hero.
---

## Endpoint

```txt
GET /api/hero-counter/<str:heroid_or_name>/
```
