...
### Direct API Access
    ...
    Click this to [Access the API directly](https://mlbb-stats.ridwaanhall.com/api/hero-rank/?days=7&rank=mythic&size=10&index=2&sort_field=pick_rate&sort_order=asc)
