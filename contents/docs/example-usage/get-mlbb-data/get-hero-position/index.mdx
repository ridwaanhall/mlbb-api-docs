...
### Direct API Access
    ...
    Click this to [Access the API directly](https://mlbb-stats.ridwaanhall.com/api/hero-position/?role=mage&lane=mid&size=10&index=2)
