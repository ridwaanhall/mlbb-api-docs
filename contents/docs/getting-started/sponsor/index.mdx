...
<Note title="Info" type="danger">
  Since there are no sponsors/donations coming in (at least $50 USD/month) and due to the high level of API usage, a hosting upgrade is required to handle more requests. Without the necessary funding, the API for the Mobile Legends game will be discontinued on July 20, 2025.
</Note>
